# Play Store listing — Qadhaaif al-Haqq (قذائف الحق)
...
- **Package name**: `org.workshopdiy.qadhaaifalhaqq`
...
```
كتاب "قذائف الحق" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
📖 قذائف الحق — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "قذائف الحق" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
### App name
```
Qadhaaif al-Haqq — Missiles of Truth
```

### Short description
```
"Missiles of Truth" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Missiles of Truth" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Missiles of Truth" — Sheikh Mohammed al-Ghazali
...
### App name
```
Qadhaaif al-Haqq — Qadhaaif al-Haqq
```

### Short description
```
« Missiles of Truth » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Missiles of Truth » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Missiles of Truth » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Qadhaaif al-Haqq
Last updated: 2026-04-26

The Qadhaaif al-Haqq app does not collect, store, transmit, or share any personal
